...
//                                //  addDescription.setDescription(value.toString());
                            ...
                            if (j ==  1){
                                String key = "des";
                                itemMap.put(key, value);
                                market.setDescription(value.toString());
                            ...
                            if (j ==  3){
                                ...
                                market.setUpdatePrice(updatePrice);
                                //addDescription.setLocation(value.toString());
...
//                    assetModel.setFound(false);
                    ...
                    MarketDatabase.getMarketDatabase(context.getApplicationContext()).marketDao().insertMarketList(market);
